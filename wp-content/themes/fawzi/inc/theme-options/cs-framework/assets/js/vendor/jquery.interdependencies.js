...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Fawzi the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is fawzid.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to fawzi condition, true show always, false hide always
         *
         */
