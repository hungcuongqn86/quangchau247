 ...
 */
require_once FAWZI_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'fawzi_register_required_plugins' );
 ...
 */
function fawzi_register_required_plugins() {
	/*
    ...
    array(
	    'name'					=> 'Fawzi Core',
	    'slug'     			=> 'fawzi-core',
	    'source'				=> 'https://victorthemes.com/plugins/fawzi-core.zip',
	    'required'			=> true,
	    'external_url'	=> 'https://victorthemes.com/wp-themes/fawzi',
    ),
    ...
    array(
	    ...
	    'required'			=> true,
	    'external_url'	=> 'http://wordpress.org/plugins/one-click-demo-import',
    ),
