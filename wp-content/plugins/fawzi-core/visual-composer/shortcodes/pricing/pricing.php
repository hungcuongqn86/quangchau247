...
/* ===========================================================
    Pricing
=========================================================== */
if ( !function_exists('fwzi_pricing_box_function')) {
  function fwzi_pricing_box_function( $atts, $content = NULL ) {
    ...
    // Btn Normal
    if ( $price_bg_color ) {
      $inline_style .= '.fwzi-pricing-'.$e_uniqid.$in_class.'.plan-item {';
      $inline_style .= ( $price_bg_color ) ? 'background-color:'. $price_bg_color .';' : '';
      $inline_style .= '}';
    }  
    // Btn Normal
    if ( $btn_text_color || $btn_background_color || $btn_border_color ) {
      $inline_style .= '.fwzi-pricing-'.$e_uniqid.$in_class.' .plan-info a.fwzi-btn.fwzi-btn-small {';
    ...
    if ( $btn_text_hover_color || $btn_background_hover_color || $btn_border_hover_color ) {
      $inline_style .= '.fwzi-pricing-'.$e_uniqid.$in_class.'.fwzi-hover .plan-info a.fwzi-btn {';
    ...
    $styled_class  = ' fwzi-pricing-'.$e_uniqid.$in_class;
    ...
    $btn_link = $btn_link ? '<a href="'.$btn_link.'" class="fwzi-btn fwzi-btn-small">'.$btn_text.'</a>' : '';

    // Output
    $output = '<div class="plan-item '.$styled_class.' '.$class.'"><div class="plan-top-wrap">'. $price_title . $price_subtitle . $price . $price_label .'</div><div class="plan-info"><ul>';
...
add_shortcode( 'fwzi_pricing_box', 'fwzi_pricing_box_function' ); ?>
